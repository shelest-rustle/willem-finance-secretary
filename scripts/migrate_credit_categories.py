...
Лики", "Tinkoff Кредит Лики", "МТС Кредит Ярослава" (названия совпадают с названиями
кредитных листов — так задала Лика в листе "Справочники") вместо общей "Платёж по
кредиту" — так бот может понять, к какому именно кредитному листу относится платёж
(см. MTS_CREDIT_TEST.md). Сидинг
...
NEW_SUBCATEGORY_NAMES = ("МТС Кредит Лики", "Tinkoff Кредит Лики", "МТС Кредит Ярослава")
