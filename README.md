...
54 теста (`poetry run pytest -q`), покрывают "чистую" бизнес-логику (запись операций, лимиты,
форматирование, синк в Sheets). Маршрутизация aiogram (какой хендлер на что реагирует)
